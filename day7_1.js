...
function goDownAndCountSplits(splits, lines, lastLineBeams) {
  ...
  if (currentLine.indexOf("S") !== -1) {
    newBeamCoordinates.push(currentLine.indexOf("S"));
    return goDownAndCountSplits(0, rest, newBeamCoordinates);
  }

  lastLineBeams.forEach((beamCoordinate) => {
    if (currentLine[beamCoordinate] === ".")
      newBeamCoordinates.push(beamCoordinate);
  ...
  if (rest.length === 0) return newSplits;
